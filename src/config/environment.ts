...
export const SERVER = {
  ...
  CHAT_MICROSERVICE_URL: process.env["CHAT_MICROSERVICE_URL"],
  ...
  SOCKET_PORT: process.env["SOCKET_PORT"] || 50007,
  ...
  SOCKET_DISCONNECT_TIMEOUT: 20000,//5000,
  IS_TRANSLATION_ENABLE: true,
